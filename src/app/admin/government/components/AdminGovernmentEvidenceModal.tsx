      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-xl border border-slate-200 bg-white text-slate-800 shadow-2xl">
        <div className="flex items-center justify-between border-b border-slate-200/80 bg-slate-50 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-extrabold text-slate-900">Upload Dossier Evidence / Proof</h3>
              <p className="text-xs text-slate-500 font-medium">Attach Official Government Documents, Receipts, or Certificates</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">Visibility Permission</label>
              <select
                value={visibility}
          ...
          <div>
            <label className="block text-xs font-bold text-slate-700 mb-1">Secure Document URL *</label>
            <input
              type="url"
              required
              value={fileUrl}
